...
Game::Game(ID3D11Device* _pd3dDevice, HWND _hWnd, HINSTANCE _hInstance) 
{
	...
	//
	////Added a test object for the player
	//Player2D* playerTest = new Player2D("PlayerTest", _pd3dDevice, true);
	//playerTest->SetScale(0.25);
	//playerTest->SetPos(Vector2(200, 200));
	//m_GameObject2Ds.push_back(playerTest);
	//
	//Enemy* enemyTest = new Enemy("PlayerTest", _pd3dDevice, Vector2(width/2, height/2), Vector2(width/4, height/2));
	//enemyTest->SetScale(0.25);
	//m_GameObject2Ds.push_back(enemyTest);
	//
	//Enemy* enemyTest2 = new Enemy("PlayerTest", _pd3dDevice, Vector2(width / 2, height / 2), Vector2(width * 0.75, height / 2));
	//enemyTest2->SetScale(0.25);
	//m_GameObject2Ds.push_back(enemyTest2);
	//
	//Enemy* enemyTest3 = new Enemy("PlayerTest", _pd3dDevice, Vector2(width / 2, height / 2), Vector2(width / 2, height / 6));
	//enemyTest3->SetScale(0.25);
	//m_GameObject2Ds.push_back(enemyTest3);
	//
	//Enemy* enemyTest4 = new Enemy("PlayerTest", _pd3dDevice, Vector2(width / 2, height / 2), Vector2(width / 2, height * 0.8));
	//enemyTest4->SetScale(0.25);
	//m_GameObject2Ds.push_back(enemyTest4);
	//
	//Enemy* enemyTest5 = new Enemy("PlayerTest", _pd3dDevice, Vector2(width / 2, height / 2), Vector2(width * 0.1, height * 0.4));
	//enemyTest5->SetScale(0.25);
